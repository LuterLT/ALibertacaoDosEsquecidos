...
function scr_abriFechar_menu()
{
    ...
    {	
		if( batalhar == true)
		{
			...
			obj_menu_pause.image_xscale = 0.6;
			obj_menu_pause.image_yscale = 0.6;
			//cria os botões
			instance_create_layer( global.center_x, global.center_y - 50, "GUI", obj_botao_voltar);
			obj_botao_voltar.image_xscale = 0.6;
			obj_botao_voltar.image_yscale = 0.6;
			instance_create_layer( global.center_x, global.center_y - 20, "GUI", obj_botao_salvar);
			obj_botao_salvar.image_xscale = 0.6;
			obj_botao_salvar.image_yscale = 0.6;
			instance_create_layer( global.center_x, global.center_y + 10, "GUI", obj_botao_opcoes);
			obj_botao_opcoes.image_xscale = 0.6;
			obj_botao_opcoes.image_yscale = 0.6;
			instance_create_layer( global.center_x, global.center_y + 40, "GUI", obj_botao_sair);
			obj_botao_sair.image_xscale = 0.6;
			obj_botao_sair.image_yscale = 0.6;
